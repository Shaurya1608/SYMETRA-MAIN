    ...
    <div className="min-h-screen bg-brand-arctic text-brand-deep font-archivo selection:bg-brand-teal selection:text-white flex flex-col items-center">
      ...
      <main className="w-full flex-1 max-w-[1000px] mx-auto px-8 py-10 md:py-16 flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
        ...
        <div className="w-full lg:w-[50%] flex flex-col justify-between" style={{ minHeight: '400px' }}>
          ...
          <div className="mt-16 flex flex-col items-start gap-12">
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <a 
                href={`https://wa.me/918128362616?text=Hi, I'm interested in a demo for ${productInfo.name}`}
                target="_blank"
                rel="noopener noreferrer"
                className="px-8 py-3 bg-[#25D366] text-white text-[11px] font-orbitron font-bold tracking-[0.2em] uppercase hover:bg-[#128C7E] transition-colors flex items-center gap-2 shadow-lg"
              >
        ...
        <div className="w-full lg:w-[50%] flex-shrink-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 max-w-[650px] ml-auto">
            {productInfo.images && productInfo.images.length > 0 ? (
              productInfo.images.map((img, index) => (
                <div key={index} className="bg-white p-1.5 md:p-2 rounded-lg border border-black/5 shadow-lg">
                  <img 
                    src={img} 
              ...
              <div className="bg-white p-2 md:p-4 rounded-xl border border-black/5 shadow-2xl mx-auto lg:ml-auto">
                <img 
